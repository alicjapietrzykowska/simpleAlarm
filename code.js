...
function alarm (){
	...
	audio.play();
	if (napAgain){
		document.querySelector("#alarmDiv span").classList.add("fa-bell").classList.remove("fa-bed");
...
function napTime(minute) {
	...
	document.querySelector('.fa-bell').classList.add("fa-bed").classList.remove("fa-bell");
	napAgain = true;
	waitForAlarm();
}
